		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CONTROL PEDIDOS - CARREFOUR",
									"targetURL": "#nttdatacontrolpedidos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nttdatacontrolpedidos-display": {
								"semanticObject": "nttdatacontrolpedidos",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nttdata.controlpedidos",
									"url": sap.ui.require.toUrl("nttdata/controlpedidos")
								}
							}
						}
					}
